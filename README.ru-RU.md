...
3. **`U0(int)`** — перехватывает все уровни (0/1/2/3): вызывает `DeviceSwitchUtilsKt.e(context, i)` (системное переключение), **и дополнительно принудительно задаёт eyebuffer**: качество(3)→2448×2448, произв./стандарт/экономия(0/1/2)→1504×1504.
